...
export default function NotFound() {
  return (
    <div className="min-h-screen flex items-center justify-center px-6" data-testid="not-found-page">
      <div className="cyber-card p-8 max-w-md w-full text-center">
        ...
        <Link to="/" className="cyber-btn inline-block bg-avaira-cyan text-white px-4 py-2 font-heading text-xs mt-6">
          Return Home
        </Link>
      </div>
    </div>
